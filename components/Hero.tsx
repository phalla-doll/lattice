        ...
        <div className="absolute inset-0 p-6 md:p-12 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-start">
                 <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                    <span className="bg-white/90 backdrop-blur-md px-4 py-2 rounded-full text-xs font-semibold tracking-wider text-gray-800 uppercase shadow-sm cursor-default hover:bg-white transition-colors">
                        Event
                    </span>
                    <button className="flex items-center gap-2 bg-white/90 backdrop-blur-md pl-4 pr-2 py-2 rounded-full text-sm font-medium text-gray-800 hover:bg-white transition-all duration-200 shadow-sm group/btn active:scale-95">
                        Building career
                 ...
                 <button className="hidden md:flex items-center gap-2 bg-white/30 backdrop-blur-xl px-6 py-3 rounded-full text-white hover:bg-white/40 transition-all duration-200 border border-white/40 shadow-lg hover:shadow-xl active:scale-95">
            ...
            <div className="flex flex-col md:flex-row items-end justify-between gap-8 relative z-10">
                <div className="max-w-2xl">
                    <span className="inline-block px-4 py-1.5 rounded-full border border-white/40 text-white text-xs font-medium mb-6 bg-white/10 backdrop-blur-md hover:bg-white/20 transition-colors cursor-default">
                        Job Opportunities
                    </span>
                ...
                <div className="hidden lg:block relative w-80 h-40">
                     {/* Floating Card 1 */}
                     <div className="absolute -top-32 right-10 bg-white p-2.5 pr-6 rounded-full flex items-center gap-4 shadow-card animate-float z-20 hover:scale-105 transition-transform duration-300">
                     ...
                     {/* Floating Card 2 */}
                     <div className="absolute -top-10 -left-10 bg-white p-2.5 pr-6 rounded-full flex items-center gap-4 shadow-card animate-float-delayed z-10 hover:scale-105 transition-transform duration-300">
                     ...
                     {/* Floating Card 3 */}
                     <div className="absolute bottom-6 right-0 bg-white p-2.5 pr-6 rounded-full flex items-center gap-4 shadow-card animate-float-slow z-30 hover:scale-105 transition-transform duration-300">
